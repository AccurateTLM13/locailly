...
| Tool registry metadata | JSON | Four stage-specific schemas (manifest, internal, public); **contract tests only** — see [tool-metadata-contract-audit.md](../04-validation/tool-metadata-contract-audit.md) |
