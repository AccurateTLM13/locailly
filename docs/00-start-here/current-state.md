...
- **Track runner** — linear pipeline only; one proof track in catalog
...
- **Step input mapping** — hardcoded for Lighthouse step IDs in `companion/pit-crew/tool-router.js`
...
| Layer | Focus |
|---|---|
| **Now** | Make the track system explicit in docs and stabilize the linear runner |
| **Next** | Declarative step input mapping; second workflow track |
