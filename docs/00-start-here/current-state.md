...
- **Smoke and contract tests** — `scripts/smoke-test.js`, `scripts/contract-test.js` (**51/51** smoke on clean server with memory disabled)
...
| Layer | Focus |
|---|---|
| **Now** | Remove legacy step-input fallbacks; keep two-track runner stable |
