...
| **02-track-system/** | Track registry, core tracks, planning | current |
...
| [../02-track-system/step-input-mapping.md](../02-track-system/step-input-mapping.md) | Input mapping gap + target | current |
...
| [../01-architecture/pit-crew-gap-analysis.md](../01-architecture/pit-crew-gap-analysis.md) | Pit Crew extraction status | current |
| [../01-architecture/memory-bridge.md](../01-architecture/memory-bridge.md) | Memory Bridge | current |
| [../01-architecture/nearby-node.md](../01-architecture/nearby-node.md) | NearbyNode (not built) | experimental |
...
| [../03-workflows/dealsniper.md](../03-workflows/dealsniper.md) | DealSniper (partial) | draft |
...
| **05-product/** | UX, setup, roadmap | current |
...
See [../99-archive/README.md](../99-archive/README.md).
